...
?>
<h1 style="font-size:14pt;text-align:center;padding:15px 0 20px 0;margin:0;font-family:'楷体_GB2312','楷体';"><?php echo Core::config('admin.index_title');?></h1>
<table class="mainTable">
	...
	<tr>
        ...
        Bootstrap版本：<b style="color:#5fd300">V<?php echo Bootstrap::VERSION;?></b> &nbsp;&nbsp;
		<!-- 最新版本：<span id="newvision_div" style="color:red">检测中...</span>-->
        </td>
	</tr>
	<?php if (Core::config('admin.show_support')) {?>
	<tr>
...
<table border="0" cellpadding="4" cellspacing="1" align="center" class="mainTable">
	...
	<tr>
		...
		<td class="td2"><?php if(function_exists("odbc_close") == 1){ echo "<font color='#5fd300'><b>√</b></font>&nbsp;支持"; }else{ echo "<font color='red'><b>×</b></font>&nbsp;不支持"; }?></td>
	</tr>
	<tr>
		...
		<td class="td2"><?php if(function_exists("mssql_close") == 1){ echo "<font color='#5fd300'><b>√</b></font>&nbsp;支持"; }else{ echo "<font color='red'><b>×</b></font>&nbsp;不支持"; }?></td>
	</tr>
	<tr>
		<td align="right" class="td1">服务器IP：</td>
		<td class="td2"><?php echo $_SERVER['SERVER_ADDR']?></td>
		<td align="right" class="td1">msql数据库：</td>
		<td class="td2"><?php if(function_exists("msql_close") == 1){ echo "<font color='#5fd300'><b>√</b></font>&nbsp;支持"; }else{ echo "<font color='red'><b>×</b></font>&nbsp;不支持"; }?></td>
	</tr>
	<tr>
		<td align="right" class="td1">服务器端口：</td>
		<td class="td2"><?php echo $_SERVER["SERVER_PORT"]?></td>
		<td align="right" class="td1">SMTP：</td>
		<td class="td2"><?php if(@get_magic_quotes_gpc("smtp")){ echo "<font color='#5fd300'><b>√</b></font>&nbsp;支持"; }else{ echo "<font color='red'><b>×</b></font>&nbsp;不支持"; }?></td>
	</tr>
	<tr>
		...
		<td class="td2"><?php if(function_exists("imageline") == 1){ echo "<font color='#5fd300'><b>√</b></font>&nbsp;支持"; }else{ echo "<font color='red'><b>×</b></font>&nbsp;不支持"; }?></td>
	</tr>
	<tr>
		<td align="right" class="td1">您的IP：</td>
		<td class="td2"><?php echo $_SERVER["REMOTE_ADDR"]?></td>
		<td align="right" class="td1">XML：</td>
		<td class="td2"><?php if(function_exists("xml_set_object")){ echo "<font color='#5fd300'><b>√</b></font>&nbsp;支持"; }else{ echo "<font color='red'><b>×</b></font>&nbsp;不支持"; }?></td>
	</tr>
	<tr>
		<td align="right" class="td1">PHP版本：</td>
		<td class="td2"><?php echo PHP_VERSION?></td>
		<td align="right" class="td1">FTP：</td>
		<td class="td2"><?php if(function_exists("ftp_login")){ echo "<font color='#5fd300'><b>√</b></font>&nbsp;支持"; }else{ echo "<font color='red'><b>×</b></font>&nbsp;不支持"; }?></td>
	</tr>
	<tr>
		<td align="right" class="td1">服务器解译引擎：</td>
		<td class="td2"><?php echo $_SERVER["SERVER_SOFTWARE"]?></td>
		<td align="right" class="td1">显示错误信息：</td>
		<td class="td2"><?php if ($supGetCfgVar){if(get_cfg_var("display_errors") == 1){ echo "<font color='#5fd300'><b>√</b></font>&nbsp;是"; }else{ echo "<font color='red'><b>×</b></font>&nbsp;否"; }}else{echo '未知';}?></td>
	</tr>
	<tr>
		...
		<td class="td2"><?php if ($supGetCfgVar){if(@get_cfg_var("allow_url_fopen") == 1){ echo "<font color='#5fd300'><b>√</b></font>&nbsp;支持"; }else{ echo "<font color='red'><b>×</b></font>&nbsp;不支持"; }}else{echo '未知';}?></td>
	</tr>
	<tr>
		...
		<td class="td2"><?php if(function_exists("gzclose")){ echo "<font color='#5fd300'><b>√</b></font>&nbsp;支持"; }else{ echo "<font color='red'><b>×</b></font>&nbsp;不支持"; }?></td>
	</tr>
	<tr>
		...
		<td class="td2"><?php echo (@get_cfg_var("zend_optimizer.optimization_level")||@get_cfg_var("zend_extension_manager.optimizer_ts")||@get_cfg_var("zend_extension_ts")) ?"<font color='#5fd300'><b>√</b></font>&nbsp;支持":'<font color="red"><b>×</b></font>&nbsp;不支持'?>		</td>
	</tr>
	<tr>
		...
		<td class="td2"><?php if(function_exists("mb_convert_encoding") == 1){ echo "<font color='#5fd300'><b>√</b></font>&nbsp;支持"; }else{ echo "<font color='red'><b>×</b></font>&nbsp;不支持"; }?></td>
	</tr>
	<tr>
		<td align="right" class="td1">客户端语种：</td>
		<td class="td2"><?php echo getenv("HTTP_ACCEPT_LANGUAGE")?></td>
		<td align="right" class="td1">Sendmail：</td>
		<td class="td2"><?php if(@get_magic_quotes_gpc("Internal Sendmail Support for Windows 4") == 1){ echo "<font color='#5fd300'><b>√</b></font>&nbsp;支持"; }else{ echo "<font color='red'><b>×</b></font>&nbsp;不支持"; }?></td>
	</tr>
	<tr>
		<td align="right" class="td1">程序路径：</td>
		<td class="td2"><?php echo DIR_SYSTEM;?></td>
		<td align="right" class="td1">运行于安全模式：</td>
		<td class="td2"><?php if($supGetCfgVar){if(get_cfg_var("safe_mode")){ echo "<font color='#5fd300'><b>√</b></font>&nbsp;是"; }else{ echo "<font color='red'><b>×</b></font>&nbsp;否"; }}else{echo '未知';}?></td>
	</tr>
	<tr>
		<td align="right" class="td1">网站类库路径：</td>
		<td class="td2"><?php echo DIR_LIBRARY;?></td>
		<td align="right" class="td1">拼写检查 ASpell Library：</td>
		<td class="td2"><?php if(function_exists("aspell_check_raw")){ echo "<font color='#5fd300'><b>√</b></font>&nbsp;支持"; }else{ echo "<font color='red'><b>×</b></font>&nbsp;不支持"; }?></td>
	</tr>
	<tr>
		<td align="right" class="td1">项目路径：</td>
		<td class="td2"><?php echo DIR_PROJECT;?></td>
		<td align="right" class="td1">高精度数学运算BCMath：</td>
		<td class="td2"><?php if(function_exists("bcadd")){ echo "<font color='#5fd300'><b>√</b></font>&nbsp;支持"; }else{ echo "<font color='red'><b>×</b></font>&nbsp;不支持"; }?></td>
	</tr>
	<tr>
		<td align="right" class="td1">WWW路径：</td>
		<td class="td2"><?php echo DIR_WWWROOT;?></td>
		<td align="right" class="td1">Socket支持：</td>
		<td class="td2"><?php if(function_exists("socket_accept")){ echo "<font color='#5fd300'><b>√</b></font>&nbsp;支持"; }else{ echo "<font color='red'><b>×</b></font>&nbsp;不支持"; }?></td>
	</tr>
</table>
<?php
}
